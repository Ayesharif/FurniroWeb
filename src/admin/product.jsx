...
<div className="flex  justify-end h-[100px] items-center">
  <button type="button" className="outline-1 outline-offset-2 p-2 px-3 font-bold rounded bg-orange-100" onClick={() => setShowAddProductBox(!showAddProductBox)}>
    Add Product
  </button>
</div>
...
></i>
      ...
      <div className={`fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:w-[500px] w-[90%] p-6 bg-orange-50 rounded shadow transition-all duration-500 ease-in-out
